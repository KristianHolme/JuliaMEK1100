...
```
Så må vi prosesserer vi dataene. Vi finner akkurat det tidspunktet vi vil ha, og henter ut de datene vi trenger. Datasettet gjelder et stort område, så vi filtrerer ut omtrent halvparten av dataene.
...
## filterer ut halvparten av dataen
...
Vi kan nå plotte konturlinjer for virvlingen. Her velger vi å zoome in på et mindre område sør for Island. 
...
## 5.7 Tolkninger
Her referer vi til kapittel 5.7 i boken, som gjelder uavhengig av programmeringsspråk.